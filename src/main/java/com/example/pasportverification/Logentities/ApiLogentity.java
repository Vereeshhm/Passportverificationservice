...
public class ApiLogentity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fetch_logs_seq")
	@SequenceGenerator(name = "fetch_logs_seq", sequenceName = "fetch_logs_seq", allocationSize = 1)
	private Long id;
